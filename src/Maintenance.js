...
import oil2 from './assets/images/oil_2.jpg';
                    ...
                    <Row>
                        <Col>
                            <Card style={{ width: '18rem' }}>
                                ...
                                <Card.Img variant="top" src={oil2} />
                                <Card.Body>
                                    <Card.Title>Changing Oil & Filter</Card.Title>
                                    <Card.Text className="mt-2">
                                        Step by step instructions on how to change the oil and filter.
                                    </Card.Text>
                        ...
                        <Col>
                            <Card style={{ width: '18rem'}}>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text className="mt-2">
                                        Step by step instructions on how to flush the radiator and Refill.
                                    </Card.Text>
                                    <Button action variant="primary">Show me how</Button>
                                </Card.Body>
                            </Card>
                        ...
                        <Col>
                            <Card style={{ width: '18rem'}}>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text className="mt-2">
                                        Step by step instructions on how to replace Transmission Fluid & Filter.
                                    </Card.Text>
                                    <Button action variant="primary">Show me how</Button>
                                </Card.Body>
                            </Card>
